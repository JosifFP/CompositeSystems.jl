...
struct SequentialMonteCarlo <: SimulationSpec
    ...
    function SequentialMonteCarlo(; samples::Int=10_000, seed::Integer=rand(UInt64), verbose::Bool=false, threaded::Bool=true)
...
function assess(system::SystemModel, method::SequentialMonteCarlo, resultspecs::ResultSpec...)
