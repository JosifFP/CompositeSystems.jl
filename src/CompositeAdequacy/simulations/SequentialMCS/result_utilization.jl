...
""
function record!(acc::SMCUtilizationAccumulator, states::States, system::SystemModel, sampleid::Int, t::Int)

    for l in eachindex(states.branches_flow_from)
        util = utilization(states.branches_flow_from[l], states.branches_flow_to[l], system.branches.rate_a[l])
        ptv = prob_thermal_violation(states.branches_flow_from[l], states.branches_flow_to[l], system.branches.rate_a[l])
...
""
function record!(acc::SMCUtilizationSamplesAccumulator, states::States, system::SystemModel, sampleid::Int, t::Int)

    for l in eachindex(states.branches_flow_from)
        acc.utilization[l, t, sampleid] = utilization(states.branches_flow_from[l], states.branches_flow_to[l], system.branches.rate_a[l])
    end
    return
end
