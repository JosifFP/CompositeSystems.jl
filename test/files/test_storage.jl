...
@testset "RBTS system, sequential outages, storage at bus 6" begin
    ...
    @testset "t=1, No outages" begin
        ...
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 1.85 - sum(OPF.topology(pm, :buses_curtailed_pd)[:]) + system.storages.charge_rating[1]; atol = 1e-4) 
    ...
    @testset "t=3, G3, G7, G8 and G9 on outage" begin
        ...
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[1], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[2], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[3], 0.1; atol = 1e-4) #without storage it should be 0.35
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[4], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[5], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[6], 0; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 1.85 - sum(OPF.topology(pm, :buses_curtailed_pd)[:]) - system.storages.charge_rating[1]; atol = 1e-4)
    ...
    @testset "t=4, L5 and L8 on outage" begin
        ...
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[1], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[2], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[3], 0; atol = 1e-4) #without storage it should be 0.35
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[4], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[5], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[6], 0.15; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 1.85 - sum(OPF.topology(pm, :buses_curtailed_pd)[:]) - system.storages.charge_rating[1]; atol = 1e-4)
    ...
    @testset "t=5, L3, L4 and L8 on outage" begin
        ...
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[5], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[6], 0; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 1.85 - sum(OPF.topology(pm, :buses_curtailed_pd)[:]) - 0.15; atol = 1e-4)
    ...
    @testset "t=6, L2 and L7 on outage, generation reduced" begin
        ...
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[1], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[2], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[3], 0.49; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[4], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[5], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[6], 0; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 1.85 - sum(OPF.topology(pm, :buses_curtailed_pd)[:]) - 0.25; atol = 1e-4)
    ...
    @testset "t=8, L1 and L6 on outage" begin
        ...
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[5], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[6], 0; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 1.85 - sum(OPF.topology(pm, :buses_curtailed_pd)[:]) - 0.23; atol = 1e-4)
...
@testset "RBTS system, sequential outages, storage at bus 2" begin
    ...
    @testset "t=4, L5 and L8 on outage" begin
        ...
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[3], 0; atol = 1e-4) #without storage it should be 0.35
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[4], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[5], 0.20; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[6], 0.20; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 1.85 - sum(OPF.topology(pm, :buses_curtailed_pd)[:]) + system.storages.charge_rating[1]; atol = 1e-4)
    ...
    @testset "t=5, L3, L4 and L8 on outage" begin
        ...
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[1], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[2], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[3], 0.15; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[4], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[5], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[6], 0; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 1.85 - sum(OPF.topology(pm, :buses_curtailed_pd)[:]) + 0.25; atol = 1e-4)
    ...
    @testset "t=8, L1 and L6 on outage" begin
        ...
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[1], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[2], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[3], 0.23; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[4], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[5], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[6], 0; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 1.85 - sum(OPF.topology(pm, :buses_curtailed_pd)[:]) + 0.25; atol = 1e-4)
...
@testset "RTS system, sequential outages, storage at bus 8" begin
    ...
    @testset "t=2, Outages on L11, L12, L13" begin
        ...
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[8], 0.71; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[9], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[10], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[11], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[12], 0; atol = 1e-4)
    ...
    @testset "t=8, Outages on L5, L11, L12, L13, L15" begin
        ...
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[6], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[7], 1.25; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[8], 0.96+0.75; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[9], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[10], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[11], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[12], 0; atol = 1e-4)
...
@testset "RTS system, sequential outages, storage at bus 9" begin
    ...
    @testset "Outages on T15, T16, L17" begin
        ...
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[7], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[8], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[9], 1.38; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[10], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[11], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[12], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[13], 0; atol = 1e-4)
    ...
    @testset "Outages on T15, T16, L17" begin
        ...
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[7], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[8], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[9], 0.63; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[10], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[11], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[12], 0; atol = 1e-4)
        @test isapprox(OPF.topology(pm, :buses_curtailed_pd)[13], 0; atol = 1e-4)
