...
function container(network::Dict{Symbol, <:Any}, asset::Type{Buses}, B::Float16, N::Int, L::Int, T::Type{<:Period})
...
function container(network::Dict{Symbol, <:Any}, asset::Type{Generators}, B::Float16, N::Int, L::Int, T::Type{<:Period})
...
function container(dict_core::Dict{<:Any}, dict_timeseries::Dict{<:Any}, network::Dict{Symbol, <:Any}, asset::Type{Generators}, B::Float16, N::Int, L::Int, T::Type{<:Period})
...
function container(network::Dict{Symbol, <:Any}, asset::Type{Loads}, B::Float16, N::Int, L::Int, T::Type{<:Period})
...
function container(dict_core::Dict{<:Any}, dict_timeseries::Dict{<:Any}, network::Dict{Symbol, <:Any}, asset::Type{Loads}, B::Float16, N::Int, L::Int, T::Type{<:Period})
...
function container(network::Dict{Symbol, <:Any}, asset::Type{Branches}, B::Float16, N::Int, L::Int, T::Type{<:Period})
...
function container(dict_core::Dict{<:Any}, network::Dict{Symbol, <:Any}, asset::Type{Branches}, B::Float16, N::Int, L::Int, T::Type{<:Period})
...
function container(network::Dict{Symbol, <:Any}, asset::Type{Shunts}, B::Float16, N::Int, L::Int, T::Type{<:Period})
