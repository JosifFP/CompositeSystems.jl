...
function SystemModel(RawFile::String; ReliabilityDataDir::String="", N::Int=1)
    ...
    B = Float16(network[:baseMVA]) #base MVA
    ...
    if has_shunts
        ...
        shunts = Shunts{N,L,T}(Int[], Int[], Float16[], Float16[], String[], Vector{Bool}())
    end
    ...
    if has_storages
        ...
        storages = Storages{N,L,T}(
            ...
            Float16[], Float16[], Float16[], Float16[], 
            Float16[], Float16[], Float16[], Float16[], 
            Float16[], Vector{Bool}(), Float64[], Float64[])
    end
