...
@testset "test 5 Split situations RBTS system" begin
    ...
    @testset "L5 and L8 on outage" begin
        ...
        CompositeAdequacy.update!(pm.topology, systemstates, system, t)
        CompositeAdequacy.solve!(pm, system, t)
        @test isapprox(sum(values(field(pm, :plc))[:]), 0.4; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[1,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[2,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[3,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[4,t], 0.2; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[5,t], 0.2; atol = 1e-3)
        CompositeAdequacy.empty_model!(pm,t)
    end
    ...
    @testset "L2 and L7 on outage, generation reduced" begin
        ...
        CompositeAdequacy.update!(pm.topology, systemstates, system, t)
        CompositeAdequacy.solve!(pm, system, t)
        @test isapprox(sum(values(field(pm, :plc))[:]), 0.7046; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[1,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[2,t], 0.65; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[3,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[4,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[5,t], 0.0542; atol = 1e-3)
        CompositeAdequacy.empty_model!(pm,t)
    end
...
@testset "test 7 Split situations IEEE-RTS system" begin
    ...
    @testset "Outages of L12, L13" begin
        ...
        @test isapprox(sum(values(field(pm, :plc))[:]), 0; atol = 1e-3)
        ...
        @test isapprox(values(field(pm, :plc))[4,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[5,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[6,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[7,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[8,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[9,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[10,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[11,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[12,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[13,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[14,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[15,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[16,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[17,t], 0; atol = 1e-3)
        CompositeAdequacy.empty_model!(pm,t)
    end
    ...
    @testset "Outages of L1, L4, L10" begin
        ...
        @test isapprox(sum(values(field(pm, :plc))[:]), 0.4111; atol = 1e-3)

        @test isapprox(values(field(pm, :plc))[1,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[2,t], 0.4111; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[3,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[4,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[5,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[6,t], 0; atol = 1e-3)
    ...
    @testset "Outages of L1, L8, L10" begin
        ...
        @test isapprox(sum(values(field(pm, :plc))[:]), 1.151; atol = 1e-3)

        @test isapprox(values(field(pm, :plc))[1,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[2,t], 0.411; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[3,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[4,t], 0.74; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[5,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[6,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[7,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[8,t], 0; atol = 1e-3)
    ...
    @testset "Outages of L7, L23, L29" begin
        ...
        @test isapprox(sum(values(field(pm, :plc))[:]), 1.653; atol = 1e-3)
        ...
        @test isapprox(values(field(pm, :plc))[14,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[15,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[16,t], 1.653; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[17,t], 0; atol = 1e-3)
        CompositeAdequacy.empty_model!(pm,t)
    end
    ...
    @testset "Outages of L25, L26, L28" begin
        ...
        @test isapprox(sum(values(field(pm, :plc))[:]), 2.125; atol = 1e-3)
        ...
        @test isapprox(values(field(pm, :plc))[7,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[8,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[9,t], 0.3147; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[10,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[11,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[12,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[13,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[14,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[15,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[16,t], 1.81; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[17,t], 0; atol = 1e-3)
        CompositeAdequacy.empty_model!(pm,t)
    end
    ...
    @testset "Outages of L29, L36, L37" begin
        ...
        @test isapprox(sum(values(field(pm, :plc))[:]), 3.09; atol = 1e-3)
        ...
        @test isapprox(values(field(pm, :plc))[15,t], 0; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[16,t], 1.81; atol = 1e-3)
        @test isapprox(values(field(pm, :plc))[17,t], 1.28; atol = 1e-3)
        CompositeAdequacy.empty_model!(pm,t)
    end
