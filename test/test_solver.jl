...
@testset "test 5 Split situations RBTS system" begin
    ...
    pm = CompositeAdequacy.PowerFlowProblem(system, method, settings, cache)
    t=1
    ...
    @testset "G3, G7, G8 and G9 on outage" begin
        ...
        CompositeAdequacy.empty!(pm, cache.vars)
...
@testset "test 7 Split situations IEEE-RTS system" begin
    ...
    @testset "Outages of L12, L13" begin
        ...
        @test isapprox(values(sol(pm, :plc))[4,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[5,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[6,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[7,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[8,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[9,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[10,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[11,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[12,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[13,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[14,t], 0; atol = 1e-3)
    ...
    @testset "Outages of L1, L4, L10" begin
        ...
        @test isapprox(values(sol(pm, :plc))[4,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[5,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[6,t], 0.4111; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[7,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[8,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[9,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[10,t], 0; atol = 1e-3)
    ...
    @testset "Outages of L1, L8, L10" begin
        ...
        @test isapprox(values(sol(pm, :plc))[4,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[5,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[6,t], 1.151; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[7,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[8,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[9,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[10,t], 0; atol = 1e-3)
    ...
    @testset "Outages of L7, L23, L29" begin
        ...
        @test isapprox(values(sol(pm, :plc))[7,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[8,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[9,t], 1.653; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[10,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[11,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[12,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[13,t], 0; atol = 1e-3)
    ...
    @testset "Outages of L25, L26, L28" begin
        ...
        @test isapprox(values(sol(pm, :plc))[7,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[8,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[9,t], 1.75; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[10,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[11,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[12,t], 0.374; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[13,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[14,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[15,t], 0; atol = 1e-3)
        @test isapprox(values(sol(pm, :plc))[16,t], 0; atol = 1e-3)
