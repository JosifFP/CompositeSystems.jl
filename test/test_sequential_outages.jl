...
@testset "test sequentially split situations w/o isolated buses, RBTS system, LPACCPowerModel" begin
    ...
    @testset "L5 and L8 on outage" begin
        ...
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 1.522; atol = 1e-3)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :qg, :)))), 0.407; atol = 1e-3)
        @test JuMP.termination_status(pm.model) ≠ JuMP.NUMERICAL_ERROR
...
@testset "test sequentially split situations w/o isolated buses, RTS system, LPACCPowerModel" begin
    ...
    @testset "Outages of L29, L36, L37" begin
        ...
        @test isapprox(systemstates.plc[23], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[24], 0; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 26.3940; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :qg, :)))), 9.0633; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :z_shunt, :)))), 1; atol = 1e-4)
        @test JuMP.termination_status(pm.model) ≠ JuMP.NUMERICAL_ERROR
    ...
    @testset "Outages of L25, L26, L28" begin
        @test isapprox(sum(systemstates.plc[:]), 2.3548; atol = 1e-4)
        @test isapprox(systemstates.plc[1], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[2], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[3], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[4], 0; atol = 1e-4)
        ...
        @test isapprox(systemstates.plc[12], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[13], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[14], 0.6048; atol = 1e-4)
        @test isapprox(systemstates.plc[15], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[16], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[17], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[18], 0; atol = 1e-4)
        ...
        @test isapprox(systemstates.plc[23], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[24], 0; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 26.8077; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :qg, :)))), 6.2502; atol = 1e-3)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :z_shunt, :)))), 1; atol = 1e-4)
        @test JuMP.termination_status(pm.model) ≠ JuMP.NUMERICAL_ERROR
    ...
    @testset "Outages of L1, L8, L10" begin
        ...
        @test isapprox(systemstates.plc[23], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[24], 0; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 28.1440; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :qg, :)))), 9.8920; atol = 1e-4)
    ...
    @testset "Outages of L7, L19, L29" begin
        ...
        @test isapprox(systemstates.plc[23], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[24], 0; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 29.2207; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :qg, :)))), 7.4490; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :z_shunt, :)))), 1; atol = 1e-4)
        @test JuMP.termination_status(pm.model) ≠ JuMP.NUMERICAL_ERROR
    end
    ...
    @testset "Outages of L7, L23, L29" begin
        @test isapprox(sum(systemstates.plc[:]), 1.95; atol = 1e-4)
        @test isapprox(systemstates.plc[1], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[2], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[3], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[4], 0; atol = 1e-4)
        ...
        @test isapprox(systemstates.plc[12], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[13], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[14], 0.20; atol = 1e-4)
        @test isapprox(systemstates.plc[15], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[16], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[17], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[18], 0; atol = 1e-4)
        ...
        @test isapprox(systemstates.plc[23], 0; atol = 1e-4)
        @test isapprox(systemstates.plc[24], 0; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :pg, :)))), 27.3266; atol = 1e-4)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :qg, :)))), 7.2444; atol = 1e-3)
        @test isapprox(sum(values(OPF.build_sol_values(OPF.var(pm, :z_shunt, :)))), 1; atol = 1e-4)
        @test JuMP.termination_status(pm.model) ≠ JuMP.NUMERICAL_ERROR
