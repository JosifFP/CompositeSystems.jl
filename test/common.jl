...
rawfile_rbts = joinpath(@__DIR__, "data/RBTS/Base/RBTS.m")
relfile_rbts = joinpath(@__DIR__, "data/RBTS/Base/R_RBTS.m")
tseriesfile_rbts = joinpath(@__DIR__, "data/RBTS/SYSTEM_LOADS.csv")
rawfile_rbts_strg = joinpath(@__DIR__, "data/RBTS/Storage/RBTS.m")
relfile_rbts_strg = joinpath(@__DIR__, "data/RBTS/Storage/R_RBTS.m")
...
rawfile_rts = joinpath(@__DIR__, "data/RTS_79_A/Base/RTS_highrate.m")
relfile_rts = joinpath(@__DIR__, "data/RTS_79_A/Base/R_RTS.m")
tseriesfile_rts = joinpath(@__DIR__, "data/RTS_79_A/SYSTEM_LOADS.csv")
rawfile_rts_strg = joinpath(@__DIR__, "data/RTS_79_A/Storage/RTS_highrate.m")
relfile_rts_strg = joinpath(@__DIR__, "data/RTS_79_A/Storage/R_RTS.m")
